"""Bring up the ZERO vx300s dual-arm workstation in MuJoCo under ros2_control.

Generated by scripts/gen_bringup.py vx300s. Edit the generator, not this file.
...
Run:  ros2 launch zero_bringup vx300s.launch.py
"""
...
CONTROLLERS = ['joint_state_broadcaster', 'left_arm_controller', 'left_gripper_controller', 'right_arm_controller', 'right_gripper_controller', 'left_left_finger_ft_broadcaster', 'left_right_finger_ft_broadcaster', 'right_left_finger_ft_broadcaster', 'right_right_finger_ft_broadcaster']
MJCF = '/home/sid/projects25/src/ZERO/zero_description/mjcf/zero_vx300s.xml'
START_OVERRIDE = '/tmp/zero_vx300s_start.xml'
...
def generate_launch_description() -> LaunchDescription:
    ...
    urdf = PathJoinSubstitution([desc, "urdf", "zero_vx300s.urdf"])
    controllers = PathJoinSubstitution([bringup, "config", "vx300s_controllers.yaml"])
    control_params = PathJoinSubstitution([bringup, "config", "vx300s_control.yaml"])
